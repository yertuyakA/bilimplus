...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    bilimPlusAuthUserSubject.add(
      BilimPlusAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<BilimPlusAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  BilimPlusAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = BilimPlusAuthUser(
      loggedIn: true,
      uid: authUid,
      userData: userData,
    );
    bilimPlusAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
