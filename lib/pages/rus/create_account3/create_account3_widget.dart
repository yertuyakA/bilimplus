...
import '/pages/rus/change_lang_app/change_lang_app_widget.dart';
                  ...
                  await showModalBottomSheet(
                    ...
                    builder: (context) {
                      return GestureDetector(
                        ...
                        child: Padding(
                          padding: MediaQuery.viewInsetsOf(context),
                          child: const ChangeLangAppWidget(),
                        ),
                      );
                    },
                  ).then((value) => safeSetState(() {}));
                                ...
                                children: [
                                  ...
                                  Align(
                                    ...
                                    child: ClipRRect(
                                      borderRadius: BorderRadius.circular(8.0),
                                      child: SvgPicture.asset(
                                        'assets/images/Exams-bro_(1)_1.svg',
                                        width: 300.0,
                                        height: 236.0,
                                        fit: BoxFit.none,
                                    ...
                                    children: [
                                      Text(
                                        FFLocalizations.of(context).getText(
                                          'h9o6tw9x' /* Войти или Загеристрироваться */,
                                        ),
                                      ...
                                      Padding(
                                        ...
                                        child: Text(
                                          FFLocalizations.of(context).getText(
                                            'c2hq9xxe' /* Войдите в систему или создайте... */,
                                          ),
                                          textAlign: TextAlign.center,
                                          style: FlutterFlowTheme.of(context)
                                              .labelLarge
