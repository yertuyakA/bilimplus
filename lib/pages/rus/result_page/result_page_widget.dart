                      ...
                      children: [
                          ...
                          child: Row(
                            ...
                            children: [
                              CircularPercentIndicator(
                                percent: functions.getPercent(widget.percent!),
                                radius: 85.0,
                                lineWidth: 25.0,
                                animation: true,
                                ...
                                backgroundColor: const Color(0x274B39EF),
                                center: Text(
                                  '${valueOrDefault<String>(
                        ...
                        Padding(
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              _model.apiResult20a = await GetMistakessCall.call(
                                token: currentUserData?.token,
                                collectionId: widget.collectionId,
                              );

                              if ((_model.apiResult20a?.succeeded ?? true)) {
                                context.pushNamed(
                                  'MistakeThemePage',
                                  queryParameters: {
                                    'tasks': serializeParam(
                                      (_model.apiResult20a?.jsonBody ?? ''),
                                      ParamType.JSON,
                                      isList: true,
                                    ),
                                  }.withoutNulls,
