                    ...
                    children: [
                      ClipRRect(
                        ...
                        child: SvgPicture.asset(
                          'assets/images/6546464645465465.svg',
                          width: double.infinity,
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        Padding(
                                          ...
                                          child: Text(
                                            FFLocalizations.of(context).getText(
                                              '2covq74e' /* Персональное обучение */,
                                            ),
                                            style: FlutterFlowTheme.of(context)
                                                .bodyLarge
                                                .override(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        Padding(
                                          ...
                                          child: Text(
                                            FFLocalizations.of(context).getText(
                                              'q153g09y' /* Подготовка к олимпиаде */,
                                            ),
                                            style: FlutterFlowTheme.of(context)
                                                .bodyLarge
                                                .override(
                                        ...
                                        Opacity(
                                          ...
                                          child: Text(
                                            FFLocalizations.of(context).getText(
                                              'hl0zrdmz' /* Будет доступно 09.03.2024 */,
                                            ),
                                            style: FlutterFlowTheme.of(context)
                                                .labelMedium
                                                .override(
